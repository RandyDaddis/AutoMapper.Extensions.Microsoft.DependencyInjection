...
namespace Dna.NetCore.Core.BLL.Services.Common
{
    public partial class County_CrudServices : ICounty_CrudServices
    {
        ...
        //public delegate County_CrudServices Factory();

        //public County_CrudServices()
        //{
        ...
        //    _queries = Ioc.Resolve<ICounty_Queries>();
        //    if (_queries == null) throw new Exception("County_CrudServices() - unable to resolve Ioc.Resolve<ICounty_Queries>()");

        //    _repository = Ioc.Resolve<ICountyRepository>();
        //    if (_repository == null)
        //        throw new Exception("County_CrudServices() - unable to resolve Ioc.Resolve<ICountyRepository>()");

        //    _mapper = Ioc.Resolve<ICountyMapper>();
        //    if (_mapper == null)
        //        throw new Exception("County_CrudServices() - unable to resolve Ioc.Resolve<ICountyMapper>()");

        //    _commandBus = Ioc.Resolve<ICommandBus>();
        //    if (_commandBus == null)
        //        throw new Exception("County_CrudServices() - unable to resolve Ioc.Resolve<ICommandBus>()");

        //    _dateTimeAdapter = Ioc.Resolve<IDateTimeAdapter>();
        //    if (_dateTimeAdapter == null) throw new Exception("County_CrudServices() - unable to resolve Ioc.Resolve<IDateTimeAdapter>()");
        //}
